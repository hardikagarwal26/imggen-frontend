  ...
  return (
    ...
    >
      ...
      sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'>
        ...
        >Transform words into stunning visuals with our AI-powered text-to-image generator. Create unique, high-quality images effortlessly and instantly.</motion.p>
        <motion.button 
        ...
        initial={{opacity:0}}
        animate={{opacity:1}}
        transition={{default:{duration:0.5} , opacity: {duration:0.8 , delay:1}}}
        >Generate Images 
        ...
        className='flex items-center justify-center gap-2 mt-10'>
            {Array(6).fill('').map((item,index)=>(
                ...
                src={index%2 === 0 ? assets.samp1 : assets.samp2} 
        ...
        className='mt-2 text-sm text-stone-500'>Generated Images for Example</motion.p>
    </motion.div>
  )
}
